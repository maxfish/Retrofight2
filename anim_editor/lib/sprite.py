...
class Sprite:
    ...
    def draw(self, screen, window_x=0, window_y=0):
        ...
        self.sprite_bank.draw_frame(screen, self.frame, dest_x, dest_y, flags)
        ...
        if Sprite.DEBUG:
            ...
            if self.hit_box and self.hit_box.w > 0 and self.hit_box.h > 0:
                pygame.draw.rect(screen, (0, 200, 0), self.hit_box.move(-window_x, -window_y), 1)
            if self.attack_box and self.attack_box.w > 0 and self.attack_box.h > 0:
                pygame.draw.rect(screen, (200, 0, 0), self.attack_box.move(-window_x, -window_y), 1)
